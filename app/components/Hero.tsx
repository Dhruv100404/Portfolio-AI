...
export default function Hero() {
  const structuredData = {
    ...
    "@type": "Person",
    "name": "Dhruv Thakkar",
    "jobTitle": "AI/ML Engineer & LLM Specialist",
    "description": "AI/ML Engineer specializing in Large Language Models, RAG Systems, and Machine Learning",
    "url": "https://dhruvthakkar.com", // Replace with your actual domain
    "sameAs": [
      "https://github.com/your-github", // Add your actual social links
  ...
  return (
    <>
      ...
      />
      <section aria-label="Introduction" className="relative min-h-[90vh] flex flex-col pt-20 md:pt-24 pb-8 md:pb-10 overflow-hidden bg-[#0a0118]">
